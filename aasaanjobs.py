...
def scrape():
    ...
    req = Request(
        "https://www.aasaanjobs.com/s/bangalore-jobs-in-bengaluru/",
    ...
    for container in containers:
        ...
        description = container.find(
            "span", {"class": "text-gray-lighter text-normal"}
        ).text
        row["jd"] = description
        ...
        company = container.find(
            "a",
            {
                "class": "track-clevertap js-no-action text-capitalize text-primary text-semibold track-search-click"
            },
        ).text
